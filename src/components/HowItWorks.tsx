  ...
  const steps = [
    {
      ...
      description:
        "Drag and drop or select any image from your device. We support all major formats.",
    ...
    },
    {
      ...
      description:
        "Select from action figure, artistic, vintage, or create custom transformation styles.",
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-slate-300 max-w-2xl mx-auto leading-relaxed">
            Transform your images in just three simple steps with our AI-powered
            platform.
          </p>
        </div>
          ...
          {steps.map((step, index) => (
            <div key={index} className="relative">
              <div className="text-center group">
                <div
                  className={`inline-flex p-6 rounded-2xl bg-gradient-to-br ${step.color} mb-6 group-hover:scale-110 transition-transform duration-300 relative`}>
        ...
        <div className="mt-16 bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
          <div className="text-center">
            ...
            <p className="text-slate-300 mb-6">
              Try our AI image transformation for free. No credit card required.
            </p>
