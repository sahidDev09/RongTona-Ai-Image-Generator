        ...
        <div className="grid md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            ...
            >
              ...
              <button className={`w-full py-4 rounded-xl font-semibold transition-all duration-300 ${plan.buttonStyle} ${plan.popular ? 'text-white hover:shadow-2xl hover:shadow-blue-500/25' : 'text-white'}`}>
                {plan.buttonText}
              </button>
            </div>
          ))}
